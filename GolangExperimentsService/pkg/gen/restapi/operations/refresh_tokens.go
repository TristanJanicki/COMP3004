...
type RefreshTokensHandlerFunc func(RefreshTokensParams) middleware.Responder

// Handle executing the request and returning a response
func (fn RefreshTokensHandlerFunc) Handle(params RefreshTokensParams) middleware.Responder {
	return fn(params)
}

// RefreshTokensHandler interface for that can handle valid refresh tokens params
type RefreshTokensHandler interface {
	Handle(RefreshTokensParams) middleware.Responder
}
...
/*RefreshTokens swagger:route GET /v1/users/refresh refreshTokens

Refreshes the users JWT token
