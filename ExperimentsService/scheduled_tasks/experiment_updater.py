...
for t in tickers:
    ...
    for r in test_results:
        threshold, t_test_t, t_test_p, shapiro_w2, shapiro_p2, rsi_price_deltas, price_delta_std_dev, price_delta_mean, volumes, volumes_mean, event_dates, price_delta_mode = r
