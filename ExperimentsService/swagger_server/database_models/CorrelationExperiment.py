...
class CorrelationExperiment(Base):
    ...
    def __init__(self, experiment_id, asset_1, asset_2, correlation=0, status="update_requested", asset_combo="equit_equit", update_requested_at=None, last_updated_at=None):
