...
type GetUserAccountParams struct {
	...
	*/
	CallerUserID string
	/*Stock Advisor user id of account to be gotten
	  Required: true
	  In: path
	*/
	UserID string
...
func (o *GetUserAccountParams) bindXRequestID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetUserAccountParams) validateXRequestID(formats strfmt.Registry) error {
...
func (o *GetUserAccountParams) bindCallerUserID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
